...
При возникновении ошибки сначала логируются детали ошибки. При этом в вышестоящий компонент приложения возвращается не исходная ошибка, а соответствующая ей ошибка приложения `app.Error`.
