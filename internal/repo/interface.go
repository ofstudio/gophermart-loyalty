...
type RepoInterface interface {
	...
	OperationUpdateFurther(ctx context.Context, opType models.OperationType, updateOp UpdateFunc) error
	OperationGetByType(ctx context.Context, userID int64, t models.OperationType) ([]models.Operation, error)
	OperationGetBalance(ctx context.Context, userID int64) ([]models.Operation, error)
